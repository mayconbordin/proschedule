 ...
 */
public class OperationSchedulingSetDetailPersistenceException extends PersistenceException {
     ...
     */
    public OperationSchedulingSetDetailPersistenceException( String message ) {
     ...
     */
    public OperationSchedulingSetDetailPersistenceException( Object ex , String message ) {
        super(ex , message);
    }
}