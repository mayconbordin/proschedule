 ...
 */
public class OperationSchedulingComponentDetailPersistenceException extends PersistenceException {
     ...
     */
    public OperationSchedulingComponentDetailPersistenceException( String message ) {
     ...
     */
    public OperationSchedulingComponentDetailPersistenceException( Object ex , String message ) {
        super(ex , message);
    }
}