...
/**
 * Diálogo de busca de operações. Implementando um adaptador através da interface
 * ISearchDialog é possível efetuar a comunicação com o diálogo, permitindo que ele
 * envie o objeto Operação selecionado.
 *
 * @author Maycon Bordin
 * @version 1.0
 * @created 04-out-2010 13:24:49
 */
public class OperationSearchDialog extends javax.swing.JDialog {
     ...
     * @param typeFilter O filtro de tipos de operação habilitadas. Valores: componente, conjunto
     */
    public OperationSearchDialog(java.awt.Frame parent, ISearchDialog dialog, String typeFilter) {
        super(parent, true);
        this.parent = parent;
        this.dialog = dialog;
    ...
    /**
     * Carrega as configurações e componentes
     */
    public void startUp() {
        presenter = new OperationPresenter();
        presenter.setTypeFilter(typeFilter);
    ...
    public void loadOperationTableModel() {
        try {
            ...
            operationTableModel = new OperationTableModel( presenter.getOperations(true) );
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(jspOperations, javax.swing.GroupLayout.DEFAULT_SIZE, 531, Short.MAX_VALUE)
                    .addContainerGap()))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(42, 42, 42)
                    .addComponent(jspOperations, javax.swing.GroupLayout.PREFERRED_SIZE, 276, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jtOperationsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtOperationsMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            if ( loadSelectedRow() ) {
                dialog.selectItem( presenter.getOperation() );
                dispose();
            }
        }
