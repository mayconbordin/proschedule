...
/**
 * Tela para adição/modificação de detalhes do conjunto
 * 
 * @author Maycon Bordin
 * @version 1.0
 * @created 04-out-2010 13:24:50
 */
public class NewSetDetailDialog extends javax.swing.JDialog {
     ...
     * @param panel Painel de conjuntos
     */
    public NewSetDetailDialog(java.awt.Frame parent, NewSetPanel panel) {
        super(parent, true);
        this.parent = parent;
        this.panel = panel;
    ...
    public void modelToView() {
        jtfOperation.setText( String.valueOf( controller.getSetDetailOperationId() ) );
        jtfLeadTimeValue.setText( String.valueOf( controller.getSetDetailLeadTimeValue() ) );
        jcbLeadTimeType.setSelectedItem( controller.getSetDetailLeadTimeType() );
    }
    ...
    private void initComponents() {
        ...
        jpOperationLayout.setHorizontalGroup(
            ...
            .addGroup(jpOperationLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jtfOperation, javax.swing.GroupLayout.DEFAULT_SIZE, 217, Short.MAX_VALUE)
        ...
        jpLeadTimeLayout.setHorizontalGroup(
            ...
            .addGroup(jpLeadTimeLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jtfLeadTimeValue, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jcbLeadTimeType, 0, 74, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jbSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbSaveActionPerformed
        try {
            ...
            if ( validOperation && validLtValue ) {
                try {
                    if ( controller.setSetDetailOperation(operation) ) {
                        controller.setSetDetailLeadTime(ltValue, ltType);
                        controller.setSetDetailOrder( panel.getDetailTableModel().getNextOrder() );
                        ...
                        MessageDialog.sucess("Conjunto " + message + " com sucesso!", parent);

                        dispose();
                    } else { //Se já houver detalhamento com mesma chave primária
                        MessageDialog.warning("O conjunto já possui esta operação salva.", parent);
                    }
    ...
    private void jbSearchOperationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbSearchOperationActionPerformed
        OperationSearchDialog dialog = new OperationSearchDialog(parent, 
                new SetOperationSearchAdapter(this), OperationType.SET_TYPE_DESCRIPTION);
