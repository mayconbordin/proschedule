 ...
 */
public class ComponentDetailTableModel extends AbstractTableModel {
     ...
     */
    public ComponentDetailTableModel() {
     ...
     */
    public ComponentDetailTableModel(List list) {
        this();
        details.addAll(list);
    }
     ...
     */
    public ComponentDetailTableModel(Set list) {
        this();
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        ComponentDetail p = (ComponentDetail) getDetails().get(rowIndex);
     ...
     */
    public void add(ComponentDetail c) {
        details.add(c);
     ...
     */
    public void remove(ComponentDetail c) {
        details.remove(c);
    ...
    public void orderByOrder() {
        Collections.sort(getDetails(), new Comparator() {
            ...
            public int compare(Object o1, Object o2) {
                return ((ComponentDetail)o1).getOrder().compareTo(((ComponentDetail)o2).getOrder());
            }
        });
     ...
     * for encontrado.
     */
    public ComponentDetail getComponentDetail(int pos) {
        if (pos < 0 || pos >= getDetails().size()) {
            return null;
        }

        return (ComponentDetail) details.get(pos);
    }
    ...
    public void loadOrder() {
        ...
        for ( int i = 0; i < size; i++ ) {
            ComponentDetail cd = (ComponentDetail) details.get(i);
            cd.setOrder(i+1);
        }
