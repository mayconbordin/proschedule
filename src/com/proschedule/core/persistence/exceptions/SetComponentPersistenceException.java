 ...
 */
public class SetComponentPersistenceException extends PersistenceException {
     ...
     */
    public SetComponentPersistenceException( String message ) {
     ...
     */
    public SetComponentPersistenceException( Object ex , String message ) {
        super(ex , message);
    }
}