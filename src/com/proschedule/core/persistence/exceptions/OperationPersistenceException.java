...
/**
 * Exception padrão para as classes relacionadas com Operação
 *
 * @author Maycon Bordin
 * @version 1.0
 * @created 04-out-2010 13:24:50
 */
public class OperationPersistenceException extends PersistenceException {
     ...
     */
    public OperationPersistenceException( Object ex , String message ) {
        super(ex , message);
    }
}