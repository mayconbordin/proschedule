...
/**
 * Exception padrão para as classes relacionadas com Conjunto
 *
 * @author Maycon Bordin
 * @version 1.0
 * @created 04-out-2010 13:24:50
 */
public class SetPersistenceException extends PersistenceException {
     ...
     */
    public SetPersistenceException( String message ) {
     ...
     */
    public SetPersistenceException( Object ex , String message ) {
        super(ex , message);
    }
}