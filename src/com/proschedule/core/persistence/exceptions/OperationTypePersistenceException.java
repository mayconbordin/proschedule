...
/**
 * Exception padrão para as classes relacionadas com Tipo de operação
 *
 * @author Maycon Bordin
 * @version 1.0
 * @created 04-out-2010 13:24:50
 */
public class OperationTypePersistenceException extends PersistenceException {
     ...
     */
    public OperationTypePersistenceException( String message ) {
     ...
     */
    public OperationTypePersistenceException( Object ex , String message ) {
        super(ex , message);
    }
}