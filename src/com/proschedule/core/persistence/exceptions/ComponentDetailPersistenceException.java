 ...
 */
public class ComponentDetailPersistenceException extends PersistenceException {
     ...
     */
    public ComponentDetailPersistenceException( String message ) {
     ...
     */
    public ComponentDetailPersistenceException( Object ex , String message ) {
        super(ex , message);
    }
}