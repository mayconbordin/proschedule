...
/**
 * Exception padrão para as classes relacionadas com Calendar
 * 
 * @author Maycon Bordin
 * @version 1.0
 * @created 04-out-2010 13:24:50
 */
public class CalendarPersistenceException extends PersistenceException {
     ...
     */
    public CalendarPersistenceException( String message ) {
     ...
     */
    public CalendarPersistenceException( Object ex , String message ) {
        super(ex , message);
    }
}
